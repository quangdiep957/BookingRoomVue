<template>
  <div id="body-class-dictionary">
    ...
    <BuidingDictionaryDetail
      ...
      :classData="JSON.parse(JSON.stringify(dataComponent.classData))"
...
import BuidingDictionaryDetail from '../Class/ClassDictionaryDetailPopup.vue'
import ClassApi from '@/apis/classApi'
import DeleteClassPopup from '../Class/DeleteClassPopup.vue'
...
export default {
  ...
  setup() {
    ...
    function onClickShowPopupDelete(id) {
      dataComponent.classData = dataComponent.dataSource.find(
        (x) => x.ClassID == id,
      )
