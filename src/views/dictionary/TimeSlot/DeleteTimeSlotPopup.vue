  ...
  >
    ...
    <template #contentPopup>
      <div class="content-popup-delete">
        {{ Resource.Messenger.requestMsgDelete }} ca học
        <b> {{ timeSlotData.TimeSlotName }}</b>
  ...
  methods: {
    ...
    async onClickAcceptDeleteUser() {
      try {
        ...
        await TimeSlotApi.delete(currentThis.timeSlotData.TimeSlotID).then(
          () => {
